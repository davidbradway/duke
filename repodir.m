function outpath = repodir(setpath, inpath)
%REPODIR returns a string to base directory of repositories
%   
...
if isempty(rootpath) 
    if ispc()
        rootpath = 'C:\Users\dpb6\Downloads\repos';
    elseif isunix()
        rootpath = '/getlab/dpb6/repos';
    else
